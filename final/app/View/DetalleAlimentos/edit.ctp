...
<?php echo $this->Form->create('DetalleAlimento'); ?>
	<fieldset>
		<legend><?php echo __('Edit Detalle Alimento'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DetalleAlimento.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('DetalleAlimento.id'))); ?></li>
