 ...
 */
	public function add() {
		...
		$entidadReceptoras = $this->Pedido->EntidadReceptora->find('list');
		$estadoPedidos = $this->Pedido->EstadoPedido->find('list');
		$turnoEntregas = $this->Pedido->TurnoEntrega->find('list');
		$alimentos = $this->Pedido->Alimento->find('list');
		$this->set(compact('entidadReceptoras', 'estadoPedidos', 'turnoEntregas', 'alimentos'));
	}
